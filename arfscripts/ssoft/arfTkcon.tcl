# To activate a console in slam, either source this file then
# use the command tkcon::Init to start the console or
# add the line
# after 1000 "source  tkcon.tcl; tkcon::Init"
# in your .slamrc file to always start a console. 
#
## tkcon.tcl
...
proc ::tkcon::Init {args} {
    ...
    ediSetupOutput -enableStdout no -enablePuts yes
	...
	RCS		{RCS: @(#) $Id: tkcon.tcl,v 1.1 2006/08/08 19:11:12 private Exp $}
